import { a as attr, c as attr_class, e as escape_html, f as attr_style, h as stringify, i as head, b as ensure_array_like, d as derived } from "../../chunks/index.js";
...
function Hero($$renderer) {
  ...
  $$renderer.push(`<section class="relative overflow-x-hidden bg-white"><div class="absolute inset-x-0 top-0 z-0 h-[1050px]" style="background-image: linear-gradient(to bottom, #171717, #23223c, #2b2d64, #2f398f, #2c45bc, #2856d2, #1e68e9, #007aff, #0090ff, #00a2fe, #00b2f6, #00c0eb)"></div> <div class="pointer-events-none absolute inset-x-0 top-0 z-0 h-[1050px]">`);
  GridBeam($$renderer, { class: "h-full w-full" });
  $$renderer.push(`<!----></div> `);
  SiteNav($$renderer, { active: "home", startTransparent: true });
  $$renderer.push(`<!---->  <div class="container-page pointer-events-none relative z-10 pt-[180px] text-center md:pt-[220px]"><h1 class="mx-auto max-w-3xl text-web-32 font-semibold text-white sm:text-web-40 md:text-web-48 lg:text-web-56">Payments Infrastructure<br/>Built for Modern Businesses.</h1> <p class="mx-auto mt-5 max-w-3xl text-balance text-para-20 text-white/70">Accept payments, automate payouts, and manage your entire payment ecosystem with a secure
			platform designed to help businesses grow faster.</p> <div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-4"><a href="/contact" class="pointer-events-auto w-full rounded-lg border border-white/20 bg-white/5 px-5 py-4 text-center font-mono text-para-16 font-medium text-white hover:bg-white/10 sm:w-auto sm:px-8">Get Started</a> <a href="/products" class="pointer-events-auto w-full rounded-lg bg-white px-5 py-4 text-center font-mono text-para-16 font-medium text-black hover:bg-gray-100 sm:w-auto sm:px-8">Explore our products</a></div></div>  <div class="container-page pointer-events-none relative z-10 mt-[120px] pb-16"><div class="relative mx-auto max-w-6xl"><img${attr("src", arrow)} alt="" class="pointer-events-none absolute -top-[176px] right-[-116px] z-20 hidden w-36 opacity-90 md:block lg:right-[-80px] lg:w-44"/> <img${attr("src", dashboard)} alt="ElixirPay dashboard" class="block w-[760px] max-w-none drop-shadow-2xl md:w-full md:max-w-full"/></div></div></section>`);
}
function PageLoader($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    {
      $$renderer2.push("<!--[0-->");
      $$renderer2.push(`<div${attr_class(`fixed inset-0 z-[200] flex items-center justify-center bg-black transition-transform duration-700 ease-in-out ${"translate-y-0"}`)}><img${attr("src", logo)} alt="ElixirPay" class="icon-spin h-14 w-14 sm:h-16 sm:w-16 md:h-20 md:w-20 svelte-jx6mac"/> <p class="absolute bottom-6 right-6 leading-none font-black tabular-nums text-white sm:bottom-10 sm:right-10" style="font-size: clamp(4rem, 12vw, 9rem);">${escape_html(progress)}%</p> <div class="absolute inset-x-0 bottom-0 h-px w-full bg-white/20"><div class="h-full bg-white transition-[width] duration-150 ease-out"${attr_style(`width: ${stringify(progress)}%`)}></div></div></div>`);
    }
    $$renderer2.push(`<!--]-->`);
  });
}
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!----> `);
    Hero($$renderer2);
    $$renderer2.push(`<!----> <section class="relative flex h-[998px] flex-col overflow-hidden bg-white svelte-1uha8ag"><img${attr("src", aboutLeftIllustration)} alt="" class="illustration-float pointer-events-none absolute left-0 top-0 h-auto w-24 sm:w-32 lg:w-40 xl:w-64 svelte-1uha8ag" style="animation-duration: 2s;"/> <img${attr("src", aboutRightIllustration)} alt="" class="illustration-float pointer-events-none absolute right-0 top-0 h-auto w-24 sm:w-32 lg:w-40 xl:w-64 svelte-1uha8ag" style="animation-duration: 2s; animation-delay: -1s;"/> <div class="container-page relative z-10 flex flex-1 flex-col items-center justify-center text-center svelte-1uha8ag"><img${attr("src", sealLogo)} alt=""${attr_class(`mx-auto h-36 w-auto ${"opacity-0"}`, "svelte-1uha8ag")}/> <p class="mx-auto mt-8 max-w-4xl text-web-24 font-semibold leading-snug sm:text-web-32 md:text-web-40 svelte-1uha8ag"><!--[-->`);
    const each_array = ensure_array_like(headingWords);
    for (let i = 0, $$length = each_array.length; i < $$length; i++) {
      let word = each_array[i];
      $$renderer2.push(`<span${attr_class(`transition-colors duration-300 ${i < revealedWordCount() ? "text-gray-900" : "text-gray-300"}`, "svelte-1uha8ag")}>${escape_html(word)} </span>`);
    }
    $$renderer2.push(`<!--]--></p></div> <div class="h-[260px] overflow-hidden border-t border-gray-200 svelte-1uha8ag"><div class="marquee-track flex h-full w-max svelte-1uha8ag"><!--[-->`);
    ...
    $$renderer2.push(`<!--]--></div></div></section>  <section class="flex flex-col bg-gray-50 py-[160px] svelte-1uha8ag"><div class="container-page text-center svelte-1uha8ag"><h2 class="mx-auto max-w-2xl text-web-32 font-semibold text-gray-800 sm:text-web-40 md:text-web-48 svelte-1uha8ag">One Platform. <br class="svelte-1uha8ag"/> Every Payment Workflow.</h2> <p class="mx-auto mt-5 max-w-lg text-para-24 text-gray-500 svelte-1uha8ag">ElixirPay brings every essential payment<br class="hidden sm:inline svelte-1uha8ag"/>workflow together in
    ...
    for (let i = 0, $$length = each_array_2.length; i < $$length; i++) {
      ...
      if (mobileOpenCategory === i) {
        ...
        for (let j = 0, $$length2 = each_array_3.length; j < $$length2; j++) {
          ...
          if (j === mobileOpenItem) {
            $$renderer2.push("<!--[0-->");
            $$renderer2.push(`<div class="mt-4 border border-gray-200 bg-gray-50 svelte-1uha8ag"><div class="border-b border-gray-200 px-6 py-5 svelte-1uha8ag"><span class="font-mono text-para-16 font-bold uppercase tracking-wide text-gray-900 svelte-1uha8ag">${escape_html(item.label)}</span></div> <div class="p-6 svelte-1uha8ag"><p class="flex gap-2 text-para-16 text-gray-500 svelte-1uha8ag"><span class="mt-0.5 shrink-0 text-gray-400 svelte-1uha8ag">✓</span> <span class="svelte-1uha8ag">${escape_html(item.description)}</span></p> <a${attr("href", `/products?category=${stringify(encodeURIComponent(category.label))}&item=${stringify(encodeURIComponent(item.label))}`)} class="mt-5 inline-block rounded-lg bg-gray-200 px-5 py-2.5 font-mono text-para-14 font-medium text-gray-900 hover:bg-gray-300 svelte-1uha8ag">${escape_html(item.cta ?? item.heading)}</a> `);
    ...
    $$renderer2.push(`<!--]--></div> <div class="relative flex flex-1 items-center gap-6 px-8 py-10 md:px-12 svelte-1uha8ag"><div class="max-w-md flex-1 xl:self-start xl:-mt-2 svelte-1uha8ag"><h3 class="text-web-26 font-bold text-gray-900 svelte-1uha8ag">${escape_html(activeItem().heading)}</h3> <p class="mt-4 text-para-18 text-gray-500 svelte-1uha8ag">${escape_html(activeItem().description)}</p> <a${attr("href", `/products?category=${stringify(encodeURIComponent(activeCategory().label))}&item=${stringify(encodeURIComponent(activeItem().label))}`)} class="mt-8 inline-flex items-center gap-1.5 rounded-lg bg-gray-100 px-5 py-2.5 font-mono text-para-16 font-medium text-gray-900 hover:bg-gray-200 svelte-1uha8ag">${escape_html(activeItem().cta ?? activeItem().heading)} <span aria-hidden="true" class="svelte-1uha8ag">→</span></a></div> `);
    ...
    $$renderer2.push(`<!--]--></div></div></section> <section class="bg-black py-[160px] text-center text-white svelte-1uha8ag"><div class="container-page svelte-1uha8ag"><h2 class="mx-auto max-w-2xl text-web-32 font-semibold sm:text-web-40 md:text-web-48 svelte-1uha8ag">Built on Trust. <br class="svelte-1uha8ag"/> Provenby Experience.</h2> <p class="mx-auto mt-6 max-w-2xl text-para-20 text-white/50 svelte-1uha8ag">The best measure of a payment platform
			isn't what we <br class="svelte-1uha8ag"/> say— it's what our
    ...
    $$renderer2.push(`<!--]--></div></div> <div class="mt-[60px] grid grid-cols-2 border-y border-gray-100 lg:grid-cols-4 svelte-1uha8ag"><!--[-->`);
