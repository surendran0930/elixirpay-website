...
<!-- Same banner as ProductsHero.svelte, reused verbatim per explicit
     request ("take the banner section from products page") — only the
     nav's active link differs. -->
<section class="relative bg-white">
	...
	<SiteNav active="industries" startTransparent />
	...
	<div class="relative z-10 h-[1200px] overflow-hidden">
		<div class="container-page pointer-events-none pt-[180px] text-center md:pt-[220px]">
			<h1 class="mx-auto max-w-3xl text-web-32 font-semibold text-white sm:text-web-40 md:text-web-48 lg:text-web-56">
				Payment Solutions<br />Built for Every Industry
			</h1>
			<p class="mx-auto mt-5 max-w-3xl text-balance text-para-20 text-white/70">
				Every industry has its own payment workflows, 
				operational challenges, and customer expectations. 
				ElixirPay provides flexible payment infrastructure designed to simplify how businesses collect, move, and manage money—regardless of the industry they operate in.
			</p>
