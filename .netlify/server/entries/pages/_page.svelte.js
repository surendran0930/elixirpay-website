...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const testimonials = [
      ...
      {
        key: "placeholder-1",
        avatar: testimonialAssetBase + "image%4.png",
        logo: testimonialLogo,
      ...
      {
        key: "placeholder-2",
        avatar: testimonialAssetBase + "image%2.png",
        logo: testimonialLogo,
      ...
      {
        key: "placeholder-3",
        avatar: testimonialAssetBase + "image%3.png",
        logo: testimonialLogo,
      ...
      {
        key: "placeholder-5",
        avatar: testimonialAssetBase + "image%5.png",
        logo: testimonialLogo,
